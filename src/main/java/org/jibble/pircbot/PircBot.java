...
import com.ancientpriest.priestbot.BotManager;
...
public abstract class PircBot implements ReplyConstants {
    ...
    protected void handleLine(String line) {
        ...
        if (command.equals("PRIVMSG") && line.indexOf(":\u0001") > 0 && line.endsWith("\u0001")) {
            ...
            this.onWhisper(sourceNick, sourceLogin, sourceHostname, line.substring(line.indexOf(" :") + 2), v3Tags);
        } else if (command.equals("USERNOTICE")) {
            this.onUserNotice(target, sourceNick, sourceLogin, sourceHostname, line.substring(line.indexOf(" :") + 2), v3Tags);
    ...
    /**
     * * This method is called whenever a USERNOTICE is sent to the Bot.
     * @param sender    The nick of the person who sent the notice.
     * @param login     The login of the person who sent the notice.
     * @param hostname  The hostname of the person who sent the notice.
     * @param message   The actual message.
     * @param tags      IRC V3 Tags.
     */

...
public final class PointsFile {
    ...
    /**
     * Creates or opens a points file using specified filename
     *
     * @param fileName
     */
    public PointsFile(String fileName) {
        ...
        if (file.exists()) {
            try {
                ...
                log.severe("[PointsFile] Unable to load " + fileName + "!");
            }
        } else {
            save();
        }
    ...
    /**
     * The loader for points files, it reads the file as UTF8 or converts the string into UTF8.
    ...
    public void load() throws IOException {
        ...
        // Clear the file & unwritten points
        lines.clear();
        props.clear();
    ...
    /**
     * Writes out the <code>key=value</code> points that were changed into
     * a .[points] file in UTF8.
     */
    public void save() {
        ...
        try {
            ...
            log.severe("[PointsFile] Unable to write to file " + fileName + "!");
        } catch (FileNotFoundException ex) {
            log.severe("[PointsFile] Unable to find file " + fileName + "!");
        }


        // Keep track of Points that were set
    ...
    /**
     * Returns a Map of all <code>users=points</code> points in the file as <code>&lt;key (java.lang.String), value (java.lang.String)></code>
     * <br /><br />
     * Example:
     * <blockquote><pre>
     * PointsFile points = new PointsFile("channel.points");
     * Map<String, String> mappedSettings;
     * <p/>
     * try {
     * 	 mappedSettings = settings.returnMap();
     * } catch (Exception ex) {
     * 	 log.info("Failed mapping settings.points");
     * }
     * </pre></blockquote>
     *
     ...
     * @throws Exception If the points file doesn't exist.
     */
    ...
    /**
     * Checks to see if the .[points] file contains the given <code>key</code>.
     *
     ...
     * @param value The <code>value</code> we will be setting inside the <code>.[points]</code> file.
     * @see #save()
     */
    ...
    public List<String> getList(String key, List<String> returnObject) {
        if (this.containsKey(key)) {
            ...
            String[] rawSplit = raw.split(PointsFile.DELIMITER);
    ...
    public void setList(String key, List<?> list) {
        ...
        for (Object p : list) {
            ...
            strValue = strValue.replaceAll(PointsFile.DELIMITER, "");
            outString += delim + strValue;
            delim = PointsFile.DELIMITER;
        }
    ...
    public Map<String, String> getMap(String key) {
        ...
        if (this.containsKey(key)) {
            ...
            String[] rawSplit = raw.split(PointsFile.DELIMITER);
            for (String p : rawSplit) {
                String[] rawSplitInner = p.split(PointsFile.DELIMITER2);
    ...
    public void setMap(String key, Map<?, ?> map) {
        ...
        while (it.hasNext()) {
            ...
            String pair = String.valueOf(pairs.getKey()).replaceAll(PointsFile.DELIMITER, "").replaceAll(PointsFile.DELIMITER2, "") + PointsFile.DELIMITER2 +
                    String.valueOf(pairs.getValue()).replaceAll(PointsFile.DELIMITER, "").replaceAll(PointsFile.DELIMITER2, "");
